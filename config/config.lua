...
Config.shops = {
	...
	valentine = {
		...
		npc = vector4(-365.08, 791.21, 116.18, 179.76), -- Location for NPC and Stable
	...
	strawberry = {
		...
		nDistance = 100.0,
		sDistance = 2.0,
		npc = vector4(-1817.85, -564.86, 156.06, 335.86),
	...
	vanhorn = {
		...
		nDistance = 100.0,
		sDistance = 2.0,
		npc = vector4(2967.53, 792.71, 51.4, 353.62),
	...
	lemoyne = {
		...
		nDistance = 100.0,
		sDistance = 2.0,
		npc = vector4(1210.73, -189.78, 101.39, 107.52),
	...
	saintdenis = {
		...
		nDistance = 100.0,
		sDistance = 2.0,
		npc = vector4(2505.53, -1453.93, 46.32, 99.45),
	...
	blackwater = {
		...
		nDistance = 100.0,
		sDistance = 2.0,
		npc = vector4(-871.0, -1369.63, 43.53, 6.64),
	...
	tumbleweed = {
		...
		nDistance = 100.0,
		sDistance = 2.0,
		npc = vector4(-5515.2, -3040.17, -2.39, 180.76),
	...
	guarma = {
		...
		nDistance = 100.0,
		sDistance = 2.0,
		npc = vector4(1340.28, -6853.88, 47.19, 68.92),
