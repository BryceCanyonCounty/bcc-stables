Horses = { -- Gold to Dollar Ratio Based on 1899 Gold Price / sellPrice is 60% of cashPrice / Cash Price is Regular Game Price
	{
		...
		colors = {
			['a_c_horse_americanpaint_greyovero']     = { color = 'Grey Overo',     cashPrice = 425, goldPrice = 20, invLimit = 200,job = {"valstable","strawstable", 'prstable'} }, -- Example with horse job locked
			['a_c_horse_americanpaint_splashedwhite'] = { color = 'Splashed White', cashPrice = 140, goldPrice = 6,  invLimit = 200,job = {} }, -- Example with horse not job locked
	...
	},
	{
		breed = 'Special',
		colors = {
			['a_c_horse_eagleflies']                 = { color = 'Eagle Flies Horse', cashPrice = 2000, goldPrice = 97,  invLimit = 200 ,job = {}},
			...
			['a_c_horse_gang_uncle']                 = { color = 'Nell II',           cashPrice = 2000, goldPrice = 97,  invLimit = 200 ,job = {}},
			['a_c_horse_gang_uncle_endlesssummer']   = { color = 'Nell IV',           cashPrice = 1500, goldPrice = 72,  invLimit = 200 ,job = {}},
		}
	},
	{
		breed = 'Other',
